...
//  COMPLETED (16) Create a String array containing the names of the desired data columns from our ContentProvider
    private final String[] MAIN_FORECAST_PROJECTION = new String[] {
...
//  COMPLETED (17) Create constant int values representing each column name's position above
    public static final int INDEX_WEATHER_COLUMN_DATE = 0;
    public static final int INDEX_WEATHER_COLUMN_MIN_TEMP = 1;
    public static final int INDEX_WEATHER_COLUMN_MAX_TEMP = 2;
    public static final int INDEX_WEATHER_COLUMN_WEATHER_ID = 3;
...
//          COMPLETED (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        switch (id) {
            case ID_FORECAST_LOADER:
                ...
                final String selection = WeatherContract.WeatherEntry.getSqlSelectForTodayOnwards();
                return new CursorLoader(this,
                        ...
                        sortOrder);
            default:
                throw new RuntimeException("No such loader implemented");
        }
