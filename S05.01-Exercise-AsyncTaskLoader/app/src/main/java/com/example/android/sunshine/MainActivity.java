...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final String LOADER_STRING_KEY = "url";
    ...
    private void loadWeatherData() {
        ...
        bundle.putString(LOADER_STRING_KEY, location);
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            String[] weatherDataCache = null;
            @Override
            public String[] loadInBackground() {

                if (args.getString(LOADER_STRING_KEY) == null)
                    return null;


                String location = args.getString(LOADER_STRING_KEY);
            ...
            protected void onStartLoading() {
                ...
                if (weatherDataCache != null) {
                    deliverResult(weatherDataCache);
                } else {
            ...
            public void deliverResult(String[] data) {
                ...
                super.deliverResult(weatherDataCache);
            }
        };
    }
