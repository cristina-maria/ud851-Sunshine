...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        String locationQuery = SunshinePreferences.getPreferredWeatherLocation(getApplicationContext());
    ...
    private class FetchWeatherTask extends AsyncTask<URL, Void, String[]> {
        ...
        protected String[] doInBackground(URL... params) {
            ...
            try {
                ...
                simpleJSONData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(
                        getApplication(),results);
        ...
        @Override
        protected void onPostExecute(String[] simpleData) {
            super.onPostExecute(simpleData);

            if (simpleData != null) {
                for (String s : simpleData) {
